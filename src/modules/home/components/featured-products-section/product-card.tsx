    ...
    <div className="relative flex flex-col overflow-hidden rounded-large shadow-medium bg-white">
      ...
      <div className="flex flex-grow flex-col p-3 bg-white">
        ...
        <div className="flex justify-start mb-2">
          <p className="flex items-center gap-1 rounded-[4px] bg-white p-1 px-2 text-xs" 
        ...
        <div className="mb-3 min-h-10">
          <p className="line-clamp-2 text-base font-semibold text-midnight text-left">
            {product.title}
          </p>
        </div>
        <div className="flex items-center justify-start mt-auto mb-2">
          <p className="text-lg font-semibold text-midnight-light">
